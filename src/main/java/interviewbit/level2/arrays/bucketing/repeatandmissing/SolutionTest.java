...
public class SolutionTest {
    ...
    @Test
    public void test1() {
        List<Integer> actual = solution.repeatedNumber(new ArrayList<Integer>(Arrays.asList(new Integer[]{3, 1, 2, 5, 3})));
